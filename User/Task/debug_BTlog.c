 ...
 * @FilePath     : \RM_17mmshooter_test\User\Task\debug_BTlog.c
 * @Descripttion : 
 * @Author       : GDDG08
...
void BTlog_Init() {
    ...
    Motor_t* feeder = &Motor_Feeder;
    MotorSnail_t* shooter_l = &Motor_Shooter_l;
    MotorSnail_t* shooter_r = &Motor_Shooter_r;
